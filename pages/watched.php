  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper"><!-- Content Wrapper. Contains page content -->
      ...
      <section class="content"><!-- Main content -->
        <form action="./scripts/search_watched.php" method="GET">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-8 offset-md-2">
                <div class="input-group">
                  <input type="text" name="search" class="form-control form-control-lg" value="<?php if (isset($_SESSION['search']['like'])) {
                                                                                                  echo $_SESSION['search']['like'];
                                                                                                } ?>">
        ...
        <div class="">
          <div class="row">
            ...
            if (isset($_SESSION['search'])) {
              ...
              $stmt = $connect->prepare("SELECT * FROM `movies` WHERE `watched`=1 ORDER BY `rate` DESC" );
              $stmt->execute();
            }
